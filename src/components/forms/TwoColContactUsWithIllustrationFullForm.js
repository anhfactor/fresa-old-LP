      ...
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            ...
            <p className="mt-4 font-medium text-secondary-100 leading-loose">Join our journey towards a sustainable future where no food goes to waste. Subscribe for updates, insights, and more.</p>
