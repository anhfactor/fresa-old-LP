...
const Heading = tw.h1`font-black text-xl md:text-xl    max-w-3xl text-left`;
const HighlightedText = tw.span`font-black text-xl md:text-xl leading-snug max-w-3xl text-primary-500 px-2 transform -skew-x-12`;
  ...
  return (
    <>
      <Container >
        <TwoColumn>
          <LeftColumn>
            <Heading>Welcome to<HighlightedText>Fresa</HighlightedText>- the key to unlocking hidden food treasures and crafting new experiences. Dive into a world where every surplus finds its purpose. </Heading>
