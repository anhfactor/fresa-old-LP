...
const Heading = tw(
  SectionHeading
)`mt-4 text-primary-500 text-left text-2xl sm:text-2xl lg:text-2xl text-center md:text-left leading-tight`;
    ...
    <Container>
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            <Heading>FOOD TOUR AND TOURISM AI</Heading>
            <Description>To entice and reward our users, Fresa will introduce coupons offering AI-curated food experiences and playful interactions. 
              Users will also have access to a sightseeing map, guiding them through a culinary journey around their community.</Description>
            {/* <PrimaryButton onClick={() => toggleModalMessageLive()}>
              {primaryButtonText}
            </PrimaryButton> */}
            <Heading>Seamless Delivery</Heading>
            <Description>Fresa is excited to announce a delivery feature that promises to bring the warmth of home-cooked meals directly to your doorstep, 
              allowing you to share the joy of food with friends and family. 
            </Description>
            {/* <PrimaryButton onClick={() => toggleModalMessageSale()}>
              {primaryButtonText}
            </PrimaryButton> */}
            <Heading>Embracing the NEW MONEY</Heading>
            <Description>Our platform now steps into the future by accepting Bitcoin, underlining our commitment to innovation and flexibility in payment methods.</Description>
